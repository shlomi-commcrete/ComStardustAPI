...
class LicenseLimitationsUtil {
    ...
    fun createSupportedFunctionalitiesByLicenseType(licenseType: LicenseType): Map<FunctionalityType, LimitationType> { // TODO: change fun name
        return FunctionalityType.entries.associateWith { type ->
            getFunctionalityLimitationByLicenseType(type, licenseType)
        }
    }
    ...
    private fun getFunctionalityLimitationByLicenseType(
        ...
        return when (licenseType) {
            ...
            LicenseType.STA -> when (functionalityType) {
                ...
                FunctionalityType.SOS -> LimitationType.ENABLED
            }
        }
    }
}